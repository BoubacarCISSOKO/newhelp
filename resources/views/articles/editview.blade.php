            ...
            <div class="card-body">
                <div class="form-group row">
                    <div class="col col-6">
                        ...
                        <input  style="border: 1px solid black;" type="text" id="inputName" class="form-control @error('name') is-danger @enderror" name="name" value="{{$article->name}}">
                        @error('name')
                    ...
                    <div class="col col-6">
                        ...
                        <input  style="border: 1px solid black;" type="text" id="inputName" class="form-control @error('price') is-danger @enderror" name="price" value="{{$article->price}}">
                        @error('price')
                          <p class="help is-danger">{{ $message }}</p>
                        @enderror
                ...
                <div class="form-group">
                    ...
                    <textarea style="border: 1px solid black;" id="inputDescription" class="form-control @error('description') is-danger @enderror" rows="4" name="description">{{$article->description}}</textarea>
                    @error('description')
                      <p class="help is-danger">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <button type="submit" class="btn btn-success float-right m-1">Modifier un article</button>
                  </div>
                </div>
            </div>
            <!-- /.card-body -->
