            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col col-6">
                        ...
                        <input style="border: 2px solid black;" type="file" id="inputClientCompany" class="form-control @error('image') is-danger @enderror" name="image" value="{{ old('image') }}">
                        @error('image')
                          <p class="help is-danger">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <button type="submit" class="btn btn-success float-right m-1">Créer une nouvelle catégorie</button>
                  </div>
                </div>
            </div>
            <!-- /.card-body -->
